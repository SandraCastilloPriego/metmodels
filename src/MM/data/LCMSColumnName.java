...
public enum LCMSColumnName {
        ...
        COMMENT("Comment", "getComment", "setComment", ".*row comment.*", ParameterType.STRING),
        ...
        ALLNAMES("All names", "getAllNames", "setAllNames", ".*Identity.*|.*All Names.*|.*All names.*|.*all Names.*|.*row all compound names.*|.*Metabolite all Names.*|.*All identity elements.*", ParameterType.STRING),
        IDENTIFICATION("Identification type", "getIdentificationType", "setIdentificationType", ".*Identification type.*|.*Identification method.*", ParameterType.STRING),
        FORMULA("Molecular formula", "getMolecularFormula", "setMolecularFormula", ".*Molecular formula.*", ParameterType.STRING),
        URL("URL", "getURL", "setURL", ".*URL.*", ParameterType.STRING),
