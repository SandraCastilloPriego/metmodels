...
import MM.taskcontrol.impl.TaskProgressWindow;
import MM.util.ExceptionUtils;
import MM.util.TextUtils;
 ...
 * 
 */
public class MainWindow extends JFrame implements MMModule, Desktop,
        WindowListener {

        static final String aboutHelpID = "MM/desktop/help/AboutMM.html";
        ...
        public void addMenuItem(MMModuleCategory parentMenu, JMenuItem newItem) {
        ...
        void updateTitle() {
                setTitle("MM " + MMCore.getMMVersion());
        }
        ...
        public void showAboutDialog() {
                MMHelpSet hs = MMCore.getHelpImpl().getHelpSet();
                if (hs == null) {
                        return;
                }
