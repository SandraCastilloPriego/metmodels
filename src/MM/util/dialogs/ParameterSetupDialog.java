 ...
 * MM; if not, write to the Free Software Foundation, Inc., 51 Franklin
 * St, Fifth Floor, Boston, MA 02110-1301 USA
 */

package MM.util.dialogs;
...
import MM.util.components.GridBagPanel;
import MM.util.components.HelpButton;
...
public class ParameterSetupDialog extends JDialog implements ActionListener,
	...
	public ParameterSetupDialog(ParameterSet parameters,
		...
		// Make dialog modal
		super(MMCore.getDesktop().getMainFrame(), "Please set parameters",
				true);
		...
		setLocationRelativeTo(MMCore.getDesktop().getMainFrame());
