 ...
 * @author scsandra
 */
public class CombineModelModule implements MMProcessingModule {

        public static final String MODULE_NAME = "Set common nodes";
       
        @Override
        public ParameterSet getParameterSet() {
                return new CombineModelParameters();
        }
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new CombineModelTask[1];
                tasks[0] = new CombineModelTask(parameters);
