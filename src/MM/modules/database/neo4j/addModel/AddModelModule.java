 ...
 * @author scsandra
 */
public class AddModelModule implements MMProcessingModule {

        public static final String MODULE_NAME = "Create new4j";
        private AddModelParameters parameters = new AddModelParameters();
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new AddModelTask[1];
                tasks[0] = new AddModelTask(MMCore.getDesktop().getSelectedDataFiles(), parameters);
