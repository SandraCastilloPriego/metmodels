 ...
 * @author scsandra
 */
public class MetacycModule implements MMProcessingModule {

        public static final String MODULE_NAME = "Metacyc";        
 
        @Override
        public ParameterSet getParameterSet() {
                return new MetacycParameters();
        }
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new MetacycTask[1];
                tasks[0] = new MetacycTask(parameters);
