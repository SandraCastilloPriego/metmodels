 ...
 * @author scsandra
 */
public class CellDesignerNamesModule implements MMProcessingModule {

        public static final String MODULE_NAME = "Cell Designer Ids Modification";        
       
        @Override
        public ParameterSet getParameterSet() {
                return new CellDesignerNamesParameters();
        }
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new CellDesignerNamesTask[1];
                tasks[0] = new CellDesignerNamesTask(MMCore.getDesktop().getSelectedDataFiles(), parameters);
