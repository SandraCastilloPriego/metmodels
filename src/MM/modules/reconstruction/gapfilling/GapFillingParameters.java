...
public class GapFillingParameters extends SimpleParameterSet {        
       ...
       // public static final StringParameter idTo = new StringParameter("Id of the final compound", "Write the id of the compound where the pathway is ending");
        public static final String choices[] = {"C00131","B00002","B00001","C00020","C00055","C00105","C00130","C00144","C00002","C00044","C00063","C00075",
            ...
            "C02185","C05819","C90001","C90002","C00390","C01080","C00288","C00115","C00698","C11481","C01478","C00320","C00058", "C00014", "C00206"};
        ...
        public GapFillingParameters() {
                super(new Parameter[]{reactionFile, boundsFile,/* data, idFrom, idTo,*/ removing});
        }
        ...
        public ExitCode showSetupDialog() {
               ...
               // getParameter(GapFillingParameters.data).setChoices(names);                
