 ...
 * @author scsandra
 */
public class GapFillingModule implements MMProcessingModule {

        public static final String MODULE_NAME = "Gap Filling";        
     
        @Override
        public ParameterSet getParameterSet() {
                return new GapFillingParameters();
        }
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new GapFillingTask[1];
                tasks[0] = new GapFillingTask( parameters);
