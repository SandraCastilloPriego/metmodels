...
import MM.desktop.preferences.*;
import MM.desktop.numberFormat.NumberFormatParameter;
import MM.desktop.numberFormat.RTFormatParameter;
import MM.desktop.numberFormat.RTFormatter;
import MM.desktop.numberFormat.RTFormatterType;
...
import MM.parameters.parametersType.OptionalModuleParameter;
...
public class GeneralconfigurationParameters extends SimpleParameterSet {
        ...
        public ExitCode showSetupDialog() {
                ...
                if (retVal == ExitCode.OK) {
                        ...
                        MMCore.getDesktop().getMainFrame().repaint();
                }
