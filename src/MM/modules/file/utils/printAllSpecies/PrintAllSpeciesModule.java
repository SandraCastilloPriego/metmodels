 ...
 * @author scsandra
 */
public class PrintAllSpeciesModule implements MMProcessingModule {

        public static final String MODULE_NAME = "Print All species";        
       
        @Override
        public ParameterSet getParameterSet() {
                return new PrintAllSpeciesParameters();
        }
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new PrintAllSpeciesTask[1];
                tasks[0] = new PrintAllSpeciesTask(MMCore.getDesktop().getSelectedDataFiles(), parameters);
