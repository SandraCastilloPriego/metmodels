 ...
 */
package MM.modules.file.utils.get_pubchem_info;
 ...
 * @author scsandra
 */
public class GetPubchemInfoModule implements MMProcessingModule {

        public static final String MODULE_NAME = "Get PubChem Information..";
        @Override
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new GetPubchemInfoTask[1];
                tasks[0] = new GetPubchemInfoTask();
