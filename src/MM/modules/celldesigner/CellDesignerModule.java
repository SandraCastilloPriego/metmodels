 ...
 * @author scsandra
 */
public class CellDesignerModule implements MMProcessingModule {

        public static final String MODULE_NAME = "Cell Designer Modification";        
       
        @Override
        public ParameterSet getParameterSet() {
                return new CellDesignerParameters();
        }
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task tasks[] = new CellDesignerTask[1];
                tasks[0] = new CellDesignerTask(MMCore.getDesktop().getSelectedDataFiles(), parameters);
